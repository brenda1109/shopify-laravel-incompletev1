...
<html lang="en">
    ...
    <head>
        ...
        <meta name="description" content="Ecommerce Controller DashBoard" />
        ...
        <div id="wrapper">
            ...
            <div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
                <div class="brand-logo">
                    ...
                    <h5 class="logo-text">Shopify Admin</h5>
                                        ...
                                        <a href="javaScript:void();">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <h6 class="mt-0 msg-title">jennie</h6>
                                                    <p class="msg-info">HAHA</p>
                                    ...
                                    <li class="list-group-item">
                                        <a href="javaScript:void();">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <h6 class="mt-0 msg-title">idk</h6>
                                                    <p class="msg-info">Hi!Nice knowing you.</p>
                                    ...
                                    <li class="list-group-item">
                                        <a href="javaScript:void();">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <h6 class="mt-0 msg-title">User456</h6>
                                                    <p class="msg-info">May I Ask?</p>
                                    ...
                                    <li class="list-group-item">
                                        <a href="javaScript:void();">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <h6 class="mt-0 msg-title">user123</h6>
                                ...
                                <li class="dropdown-item user-details">
                                    <a href="javaScript:void();">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h6 class="mt-2 user-title">Brenda</h6>
                                                <p class="user-subtitle">brenda_1109@outlook.com</p>
                                            </div>
                                        </div>
                                    </a>
                                </li>
